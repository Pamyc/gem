...
import ElevatorsByLiterGeneralChart from '../helperStatsPage/components/ElevatorsByLiterGeneralChart';
...
const ChartsSection: React.FC<ChartsSectionProps> = ({ isDarkMode, mainColor }) => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 2xl:grid-cols-3 min-[2000px]:grid-cols-3 gap-6">
      <GeneralChartCard config={SumElevatorDataConfig} limit={8} showTotal valueSuffix=" шт.">
        {(data, isExpanded) => (
          <PieDonutChart 
            paletteType={mainColor as PaletteType}
      ...
      {/* Using the original complex chart for now */}
