...
interface FloorsByCustomerChartProps {
  isDarkMode: boolean;
  selectedCity: string;
  selectedRegion?: string;
}

const FloorsByCustomerChart: React.FC<FloorsByCustomerChartProps> = ({ isDarkMode, selectedCity, selectedRegion }) => {
  ...
  const chartOption = useMemo(() => {
    ...
    const idxElevators = headers.indexOf('Кол-во этажей');
...
export default FloorsByCustomerChart;
